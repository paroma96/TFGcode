...
#ifdef ESP32BUILD
#define AP_NAME "ESP32_LoRa-Gway"
#else
#define AP_NAME "ESP8266_LoRa-Gway"
#endif
...
#define _TTNSERVER "192.168.1.132"
...
#define _DESCRIPTION "ESP32 Gateway SC TFG"
#define _EMAIL "pablorodrimar@correo.ugr.es"
