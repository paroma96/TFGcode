...
// Show received message status on OLED display
      ...
      display.drawString(45, 16, String(prssi-rssicorr));
      //display.drawString(70, 16, ",SNR: " );
      //display.drawString(110, 16, String(SNR) );
      display.drawString(70, 16, ",SF: " );
      display.drawString(100, 16, String(LoraUp.sf) );
	  ...
	  if (message[2] < 0x10) display.drawString( 72, 32, "0"+String(message[2], HEX)); else display.drawString( 72, 32, String(message[2], HEX));
	  if (message[1] < 0x10) display.drawString(93, 32, "0"+String(message[1], HEX)); else display.drawString(93, 32, String(message[1], HEX));
      ...
      if(_cad){
        ...
        display.setTextAlignment(TEXT_ALIGN_LEFT);
        display.drawString(70, 52, "CAD ON" );
      }
      display.display();
	  yield();
#endif
